...
class Robot:
    ...
    def asset(self, asset: gymapi.Asset) -> None:
        ...
        print("actuated_dof_names:", self.actuated_dof_names)
        ...
        print("self.urdf.joints:", [joint.name for joint in self.urdf.joints])
        ...
        print("mimic_multiplier:", self.mimic_multiplier)
