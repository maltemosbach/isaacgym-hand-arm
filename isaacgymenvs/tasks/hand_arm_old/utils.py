...
class URDFRobot:
    def __init__(self, rootpath: str, filename: str) -> None:
        ...
        print("os.path.join(self.rootpath, self.filename):", os.path.join(self.rootpath, self.filename))
        input()
    ...
    def attach_simulation(self, gym, sim, dof_cfg: DictConfig, device: torch.device) -> gymapi.Asset:
        ...
        self.rigid_body_names = self.gym.get_asset_rigid_body_names(self.isaacgym_asset)
